...
- `week-1-publish-pack.md`: 使用 `python3 tools/promotion_publish_pack.py --week 1` 產生的發布包，包含說明欄文案、追蹤連結、字幕節奏、視覺提示與 KPI 回填起點。
...
```bash
python3 tools/promotion_publish_pack.py --week 1
```
