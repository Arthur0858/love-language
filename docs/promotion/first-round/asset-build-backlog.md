...
- ID：`iris-free_story_card_upgrade`
- 優先序：`later`
- 階段：`collect_signal`
...
- 安全邊界：不承諾療效，不替代諮商，不把短影片 CTA 改成直接購買。

### PDF 練習卡

- ID：`iris-pdf_practice_card`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：1 頁可列印 PDF
...
- ID：`noah-free_story_card_upgrade`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：1080x1920 story card / share card
- 觸發條件：free_keepsake_downloads 或 keepsake_clicks 開始出現
...
- ID：`vivian-free_story_card_upgrade`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：1080x1920 story card / share card
- 觸發條件：free_keepsake_downloads 或 keepsake_clicks 開始出現
...
- ID：`vivian-affiliate_book_bundle`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：每位守護者 1-3 本延伸書卷包裝
- 觸發條件：affiliate_book_clicks 大於 0
...
- ID：`claire-free_story_card_upgrade`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：1080x1920 story card / share card
- 觸發條件：free_keepsake_downloads 或 keepsake_clicks 開始出現
...
- ID：`claire-affiliate_book_bundle`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：每位守護者 1-3 本延伸書卷包裝
- 觸發條件：affiliate_book_clicks 大於 0
...
- ID：`dora-free_story_card_upgrade`
- 優先序：`later`
- 階段：`collect_signal`
- 格式：1080x1920 story card / share card
- 觸發條件：free_keepsake_downloads 或 keepsake_clicks 開始出現
...
- Shorts CTA：完成 15 題測驗，找到你的情感守護者
- 不使用診斷、療效、保證修復或必須購買的說法。
- 空資料時只準備資產，不提前改公開商品優先序。
