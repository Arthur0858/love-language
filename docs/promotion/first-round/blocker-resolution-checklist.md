...
- [ ] `profile_link_youtube_shorts`（profile_setup / ready_to_act）
  ...
  - writeback：`python3 tools/promotion_profile_text_import.py add --input docs/promotion/first-round/proof-youtube_shorts.txt --proof-note "screenshot profile-youtube_shorts-2026-06-14.png verified"`
- [ ] `profile_link_tiktok`（profile_setup / ready_to_act）
  ...
  - writeback：`python3 tools/promotion_profile_text_import.py add --input docs/promotion/first-round/proof-tiktok.txt --proof-note "screenshot profile-tiktok-2026-06-14.png verified"`
- [ ] `profile_link_instagram_reels`（profile_setup / ready_to_act）
  ...
  - writeback：`python3 tools/promotion_profile_text_import.py add --input docs/promotion/first-round/proof-instagram_reels.txt --proof-note "screenshot profile-instagram_reels-2026-06-14.png verified"`
...
- [ ] `first_batch_minimum_kpi_rows`（kpi_backfill / blocked_until_post_urls）
  ...
  - writeback：`python3 tools/promotion_post_text_import.py add --input <post-proof.txt> --proof-note "public URL and KPI source checked YYYY-MM-DD"`
- [ ] `no_real_leads`（lead_collection / blocked_until_real_request）
  ...
  - writeback：`python3 tools/promotion_lead_text_import.py add --input <lead-request.txt> --proof-note "email thread or form request checked YYYY-MM-DD"`
