...
- `wrong_post_url_or_platform`：Post URL domain does not match YouTube/TikTok/Instagram platform row, or URL points to the wrong post. Stop：Do not write back; do not reuse the URL in weekly review.
