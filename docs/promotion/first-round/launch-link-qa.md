...
### shorts:all:claire_ask_help

- type：`shorts`
- platform：`all`
- guardian：`claire`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `claire_ask_help`
...
- status：`ready_to_test`
- notes：Unique Shorts campaign link shared across platforms for this script.

### shorts:all:claire_promises

- type：`shorts`
- platform：`all`
- guardian：`claire`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `claire_promises`
...
### shorts:all:claire_tired

- type：`shorts`
- platform：`all`
- guardian：`claire`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `claire_tired`
...
### shorts:all:dora_after_conflict

- type：`shorts`
- platform：`all`
- guardian：`dora`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `dora_after_conflict`
...
### shorts:all:dora_consent

- type：`shorts`
- platform：`all`
- guardian：`dora`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `dora_consent`
...
### shorts:all:dora_distance

- type：`shorts`
- platform：`all`
- guardian：`dora`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `dora_distance`
...
### shorts:all:iris_affirmation

- type：`shorts`
- platform：`all`
- guardian：`iris`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `iris_affirmation`
...
### shorts:all:iris_silence

- type：`shorts`
- platform：`all`
- guardian：`iris`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `iris_silence`
...
### shorts:all:iris_too_sensitive

- type：`shorts`
- platform：`all`
- guardian：`iris`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `iris_too_sensitive`
...
### shorts:all:noah_cancel

- type：`shorts`
- platform：`all`
- guardian：`noah`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `noah_cancel`
...
### shorts:all:noah_phone

- type：`shorts`
- platform：`all`
- guardian：`noah`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `noah_phone`
...
### shorts:all:noah_quiet_time

- type：`shorts`
- platform：`all`
- guardian：`noah`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `noah_quiet_time`
...
### shorts:all:vivian_forgotten_date

- type：`shorts`
- platform：`all`
- guardian：`vivian`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `vivian_forgotten_date`
...
### shorts:all:vivian_remembered

- type：`shorts`
- platform：`all`
- guardian：`vivian`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `vivian_remembered`
...
### shorts:all:vivian_ritual

- type：`shorts`
- platform：`all`
- guardian：`vivian`
- utm：`shorts` / `social` / `first_round_quiz_completion` / `vivian_ritual`
