...
- proof note template：`screenshot profile-youtube_shorts-2026-06-14.png verified`
...
- [ ] `proof_capture_ready`：截圖或證據命名已準備，設定前先準備 proof note，例如 screenshot profile-{platform}-YYYY-MM-DD.png verified。
- [ ] `do_not_publish_wrong_account`：錯帳號時停止發布，若帳號名稱、頻道、權限或公開頁不一致，不設定 profile link，也不發布貼文。

## TikTok（`tiktok`）

- planned profile link：https://lovetypes.tw/start/?utm_source=tiktok&utm_medium=social_profile&utm_campaign=first_round_quiz_completion&utm_content=tiktok_bio
- current tracker status：`planned`
- proof note template：`screenshot profile-tiktok-2026-06-14.png verified`
...
- planned profile link：https://lovetypes.tw/start/?utm_source=instagram&utm_medium=social_profile&utm_campaign=first_round_quiz_completion&utm_content=instagram_reels_bio
- current tracker status：`planned`
- proof note template：`screenshot profile-instagram_reels-2026-06-14.png verified`
