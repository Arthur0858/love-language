...
- 標題：他沉默時，你最想聽見哪一句話？
- 目前狀態：`planned`
- 回填：`python3 tools/promotion_post_writeback.py update --platform youtube_shorts --task-id publish-lt-s01-iris-silence --status published --published-date 2026-06-14 --post-url <REAL_YOUTUBE_SHORTS_URL> --proof-note "public URL post checked 2026-06-14"`
...
- 標題：他沉默時，你最想聽見哪一句話？
- 目前狀態：`planned`
- 回填：`python3 tools/promotion_post_writeback.py update --platform tiktok --task-id publish-lt-s01-iris-silence --status published --published-date 2026-06-14 --post-url <REAL_TIKTOK_VIDEO_URL> --proof-note "public URL post checked 2026-06-14"`
...
- 標題：他沉默時，你最想聽見哪一句話？
- 目前狀態：`planned`
- 回填：`python3 tools/promotion_post_writeback.py update --platform instagram_reels --task-id publish-lt-s01-iris-silence --status published --published-date 2026-06-14 --post-url <REAL_INSTAGRAM_REEL_URL> --proof-note "public URL post checked 2026-06-14"`
