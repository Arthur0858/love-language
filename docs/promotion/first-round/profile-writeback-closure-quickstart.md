...
- direct set：`python3 tools/promotion_profile_writeback.py update --platform youtube_shorts --status set --set-date 2026-06-29 --proof-note "<REAL_SCREENSHOT_OR_PROFILE_CLICK_NOTE> verified"`
- direct live：`python3 tools/promotion_profile_writeback.py update --platform youtube_shorts --status live --set-date 2026-06-29 --proof-note "<REAL_PROFILE_CLICK_NOTE> verified"`
