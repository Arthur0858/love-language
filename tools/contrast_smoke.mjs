...
const CASES = [
  ...
  { name: 'garden-map-en-mobile', path: '/en/garden-map/', width: 390, height: 844 },
  { name: 'garden-map-ja-mobile', path: '/ja/garden-map/', width: 390, height: 844 },
  { name: 'garden-map-ko-mobile', path: '/ko/garden-map/', width: 390, height: 844 },
  { name: 'garden-map-es-mobile', path: '/es/garden-map/', width: 390, height: 844 },
