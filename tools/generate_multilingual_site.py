...
REPAIR_PLAN = {
    "zh": {
        ...
        "resume_intro": "你上次認領的守護者可以直接帶入這份工作表。先做今天的小任務，再從指南、關係羅盤或守護者頁選一個下一步。",
        "resume_fill": "帶入工作表",
        "resume_plan": "跳到守護者任務",
        "fields": [("我的守護者結果", "例如：艾莉絲，肯定的言詞"), ("這週最明顯的錯頻", "寫一個具體場景，不寫全部舊帳"), ("我真正想提出的小請求", "縮成 24 小時內可做到的一步"), ("我選擇的下一步", "指南、工作表、關係羅盤或守護者頁")],
        "days": [
            ...
            ("第 4 天", "選一個練習", "從指南、工作表或關係羅盤選一個入口，不必在同一天完成所有內容。"),
...
ABOUT_GARDEN_PASS = {
    "zh": {
        ...
        "intro": "這一頁說明守護者內容如何製作、測驗與工具如何驗證，以及哪些情況應停止使用網站練習並尋求正式支援。",
        "cards": [
            ("01", "內容來源印", "每一盞燈都要回到真實關係情境、五種愛之語與可練習的小行動。"),
            ("02", "旅程路線印", "測驗結果會接到守護者解讀、深度指南、7 日修復與關係羅盤，讓結果回到一個可完成的免費練習。"),
...
LONG_TAIL_COMPATIBILITY_PAGES = {
    ...
    "lonely-in-relationship": {
        "zh": {
            "title": "在關係裡感到孤單怎麼辦｜LoveTypes 關係羅盤",
            "desc": "當你有伴卻覺得孤單、相處時仍不被陪伴，LoveTypes 羅盤幫你分辨優質時光錯頻、回應落差、情緒距離與可說出口的小請求。",
            "eyebrow": "LONELY TOGETHER",
            "h1": "在關係裡感到孤單：先分清楚陪伴、回應與情緒距離",
            "intro": "如果你搜尋在關係裡感到孤單、有伴卻孤單、lonely in relationship 或明明在一起卻像一個人，LoveTypes 會先幫你把孤單拆成：需要真正陪伴、需要被回應、需要被記得，還是這段關係已經長期失去安全連結。",
            "primary": "開始免費關係羅盤",
            "secondary": "看心語合盤總入口",
            "offer": "登記孤單感修復報告",
            "offer_subject": "LoveTypes 關係孤單感修復報告需求",
            "offer_body": "我想登記 LoveTypes 關係孤單感修復報告。\n我的守護者：\n對方守護者：\n我最常感到孤單的情境：\n我真正想被陪伴或回應的方式：\n我可以先提出的小請求：\n可回覆 email：\n",
            "sections": [
                ("把孤單定位到一個場景", "先不要只說我很孤單。寫下它最常出現在哪裡：吃飯滑手機、睡前沒對話、訊息沒有回應，或重要時刻沒有人在場。"),
                ("分清楚陪伴和在旁邊", "人在旁邊不等於真正陪伴。若你的守護者偏向優質時光，你可能需要的是被專心聽見，而不是同一個空間裡各自忙。"),
                ("提出低壓力的連結請求", "把你都不陪我改成：這週我們能不能有 20 分鐘不滑手機，只聊今天最累和最想被理解的一件事？"),
            ],
            "faq": [
                ("有伴卻孤單是不是代表不適合？", "不一定。可能是優質時光錯頻、回應方式不同、壓力下疏離，也可能是長期情緒距離；羅盤會先分辨模式。"),
                ("我該怎麼跟伴侶說我很孤單？", "用具體情境和小請求開始，比直接指責更容易被接住。先說我在睡前沒有對話時會覺得很遠，再提出一個 20 分鐘的請求。"),
                ("如果對方嘲笑我的孤單感呢？", "如果對方長期嘲笑、羞辱、控制或否認你的感受，請優先尋求可信任的人與專業安全支援。"),
            ],
        },
        "en": {
            "title": "Lonely in a Relationship | LoveTypes",
            "desc": "If you feel lonely in a relationship, use the LoveTypes Compass to separate quality-time mismatch, response gaps, emotional distance, and one small request.",
            "eyebrow": "LONELY TOGETHER",
            "h1": "Lonely in a relationship: separate presence, response, and emotional distance",
            "intro": "If you searched lonely in a relationship, feeling alone with a partner, or together but alone, LoveTypes helps you separate whether you need real presence, clearer response, being remembered, or protection from a long-term loss of safe connection.",
            "primary": "Start free Relationship Compass",
            "secondary": "Open compatibility hub",
            "offer": "Request loneliness repair report",
            "offer_subject": "LoveTypes relationship loneliness repair report request",
            "offer_body": "I want to request a LoveTypes relationship loneliness repair report.\nMy guardian:\nTheir guardian:\nSituation where I feel lonely:\nWay I want to be present with or answered:\nSmall request I can try first:\nReply email:\n",
            "sections": [
                ("Locate loneliness in one scene", "Instead of only saying I feel lonely, name where it appears most: phones at dinner, no bedtime talk, unanswered messages, or no one present at important moments."),
                ("Separate presence from being nearby", "Being in the same room is not the same as presence. If your guardian leans toward quality time, you may need focused listening, not just sharing space."),
                ("Ask for one low-pressure connection", "Change you never spend time with me into: this week, can we take 20 minutes with no phones and each share one thing that felt heavy today?"),
            ],
            "faq": [
                ("Does feeling lonely with a partner mean we are wrong for each other?", "Not automatically. It may be quality-time mismatch, response style, stress distance, or long-term emotional distance; the compass names the pattern first."),
                ("How do I tell my partner I feel lonely?", "Start with a concrete scene and one small request. I feel far away when we do not talk before sleep is easier to answer than a broad accusation."),
                ("What if they mock my loneliness?", "If they repeatedly mock, humiliate, control, or deny your feelings, prioritize trusted people and professional safety support."),
            ],
        },
        "ja": {
            "title": "恋人がいても孤独を感じる時｜LoveTypes",
            "desc": "恋人がいても孤独、一緒にいても満たされない時、優質時光の錯頻、返事のずれ、情緒的距離と小さなお願いを整理します。",
            "eyebrow": "LONELY TOGETHER",
            "h1": "恋人がいても孤独な時は、陪伴・反応・情緒的距離を分けて見る",
            "intro": "恋人がいても孤独、一緒にいるのに一人みたい、関係の中で孤独を感じる時、LoveTypes は本当に必要な陪伴、返してほしい反応、覚えてほしいこと、安全なつながりが失われていないかを整理します。",
            "primary": "無料コンパスを始める",
            "secondary": "相性入口を見る",
            "offer": "孤独感修復レポートを希望",
            "offer_subject": "LoveTypes 孤独感修復レポート希望",
            "offer_body": "LoveTypes 孤独感修復レポートを希望します。\n私の守護者：\n相手の守護者：\n孤独を感じる場面：\n本当にほしい陪伴や反応：\n最初に出せる小さなお願い：\n返信用 email：\n",
            "sections": [
                ("孤独を一つの場面に置く", "ただ寂しい、で止めず、食事中のスマホ、寝る前に会話がない、返信がない、大事な時にいないなど具体化します。"),
                ("そばにいることと陪伴を分ける", "同じ部屋にいることは本当の陪伴とは限りません。優質時光型なら、同じ空間より集中して聞いてもらうことが必要かもしれません。"),
                ("低圧のつながりをお願いする", "全然陪伴してくれない、ではなく、今週20分だけスマホなしで今日一番疲れたことを話せる？にします。"),
            ],
            "faq": [
                ("恋人がいても孤独なら合わないのですか？", "必ずしもそうではありません。優質時光の錯頻、反応の違い、ストレスによる距離、長期の情緒的距離を分けます。"),
                ("孤独だとどう伝えればいいですか？", "具体的な場面と小さなお願いから始めます。寝る前に会話がない時、遠く感じる、と言う方が返しやすいです。"),
                ("相手が孤独感を笑う場合は？", "嘲笑、侮辱、支配、感情の否定が続く場合は、信頼できる人や専門的な安全支援を優先してください。"),
            ],
        },
        "ko": {
            "title": "연애 중인데 외로울 때｜LoveTypes",
            "desc": "연애 중인데 외롭고 함께 있어도 혼자인 느낌이 들 때, 함께 있음과 진짜 존재감, 반응 차이, 정서적 거리와 작은 요청을 정리합니다.",
            "eyebrow": "LONELY TOGETHER",
            "h1": "연애 중인데 외롭다면 함께 있음, 반응, 정서적 거리를 나누어 보세요",
            "intro": "연애 중인데 외롭다, 같이 있는데 혼자인 것 같다, 관계 안에서 외로움을 느낀다면 LoveTypes는 진짜 필요한 함께 있음, 듣고 싶은 반응, 기억되고 싶은 마음, 안전한 연결이 약해졌는지를 정리합니다.",
            "primary": "무료 컴퍼스 시작",
            "secondary": "궁합 허브 보기",
            "offer": "외로움 회복 리포트 요청",
            "offer_subject": "LoveTypes 관계 외로움 회복 리포트 요청",
            "offer_body": "LoveTypes 관계 외로움 회복 리포트를 요청합니다.\n나의 수호자:\n상대 수호자:\n외로움을 느끼는 상황:\n내가 진짜 원하는 함께 있음이나 반응:\n먼저 말할 작은 요청:\n답장 email:\n",
            "sections": [
                ("외로움을 한 장면에 놓기", "그냥 외롭다고만 하지 말고 식사 중 휴대폰, 자기 전 대화 없음, 답장 없음, 중요한 순간에 부재 같은 장면으로 씁니다."),
                ("옆에 있음과 진짜 함께함 나누기", "같은 공간에 있는 것이 진짜 함께함은 아닙니다. 우선순위가 함께 보내는 시간이라면 집중해서 들어주는 시간이 필요할 수 있습니다."),
                ("낮은 압력의 연결 요청하기", "넌 날 안 챙겨 대신 이번 주 20분만 휴대폰 없이 오늘 가장 힘들었던 일을 하나씩 말할 수 있어?라고 작게 요청합니다."),
            ],
            "faq": [
                ("연애 중인데 외로우면 맞지 않는 건가요?", "반드시 그렇지는 않습니다. 함께하는 시간의 엇갈림, 반응 방식 차이, 스트레스 거리, 장기적 정서 거리인지 나눠 봅니다."),
                ("외롭다고 어떻게 말해야 하나요?", "구체적인 장면과 작은 요청으로 시작하세요. 자기 전 대화가 없을 때 멀게 느껴져라고 말하면 상대가 더 답하기 쉽습니다."),
                ("상대가 외로움을 비웃으면요?", "조롱, 모욕, 통제, 감정 부정이 계속된다면 믿을 수 있는 사람과 전문 안전 지원을 우선하세요."),
            ],
        },
        "es": {
            "title": "Sentirse Sola en una Relación | LoveTypes",
            "desc": "Si te sientes sola en una relación, separa presencia real, diferencias de respuesta, distancia emocional y una petición pequeña con LoveTypes.",
            "eyebrow": "LONELY TOGETHER",
            "h1": "Sentirse sola en una relación: separa presencia, respuesta y distancia emocional",
            "intro": "Si buscaste sentirse sola en una relación, tengo pareja pero me siento sola o estamos juntos pero me siento sola, LoveTypes ayuda a distinguir si necesitas presencia real, una respuesta más clara, ser recordada o protegerte de una pérdida prolongada de conexión segura.",
            "primary": "Empezar brújula gratis",
            "secondary": "Abrir hub de compatibilidad",
            "offer": "Pedir informe de soledad relacional",
            "offer_subject": "Petición de informe LoveTypes soledad relacional",
            "offer_body": "Quiero pedir un informe LoveTypes de soledad relacional.\nMi guardiana:\nSu guardiana:\nSituación donde me siento sola:\nForma en que quiero presencia o respuesta:\nPetición pequeña que puedo probar primero:\nEmail de respuesta:\n",
            "sections": [
                ("Ubicar la soledad en una escena", "En vez de decir solo me siento sola, nombra dónde aparece: teléfono en la cena, no hablar antes de dormir, mensajes sin respuesta o ausencia en momentos importantes."),
                ("Separar presencia de estar cerca", "Estar en el mismo cuarto no siempre es presencia real. Si tu guardiana se inclina al tiempo de calidad, quizá necesitas escucha enfocada, no solo compartir espacio."),
                ("Pedir una conexión de baja presión", "Cambia nunca estás conmigo por: esta semana, ¿podemos tomar 20 minutos sin teléfono para contar una cosa pesada del día?"),
            ],
            "faq": [
                ("¿Sentirme sola con pareja significa que no somos compatibles?", "No automáticamente. Puede ser desajuste de tiempo de calidad, estilo de respuesta, distancia por estrés o distancia emocional prolongada."),
                ("¿Cómo le digo que me siento sola?", "Empieza con una escena concreta y una petición pequeña. Me siento lejos cuando no hablamos antes de dormir es más fácil de responder que una acusación amplia."),
                ("¿Y si se burla de mi soledad?", "Si se burla, humilla, controla o niega tus sentimientos de forma repetida, prioriza personas de confianza y apoyo profesional de seguridad."),
            ],
        },
    },
    "partner-doesnt-listen": {
        "zh": {
            "title": "伴侶不聽我說怎麼辦｜LoveTypes 關係羅盤",
            "desc": "當你覺得伴侶不聽你說、講了很多次都沒用，LoveTypes 羅盤幫你分辨回應落差、愛之語錯頻、壓力防衛與下一句小請求。",
            "eyebrow": "LISTENING GAP",
            "h1": "伴侶不聽我說：把沒被聽見翻成可回答的請求",
            "intro": "如果你搜尋伴侶不聽我說、講了很多次都沒用、partner doesn't listen 或對方總是打斷和轉移話題，LoveTypes 會先幫你分清楚：對方是沒接收到重點、壓力下防衛、愛之語錯頻，還是已經長期否認你的感受。",
            "primary": "開始免費關係羅盤",
            "secondary": "看心語合盤總入口",
            "offer": "登記傾聽修復報告",
            "offer_subject": "LoveTypes 傾聽修復報告需求",
            "offer_body": "我想登記 LoveTypes 傾聽修復報告。\n我的守護者：\n對方守護者：\n我最常覺得沒被聽見的情境：\n我真正想被接住的重點：\n我可以先提出的小請求：\n可回覆 email：\n",
            "sections": [
                ("先抓一句沒被聽見的重點", "不要一次重播整段爭吵。先寫下你最希望對方聽到的一句話，以及對方當時怎麼岔開、反駁或沉默。"),
                ("把控訴改成回應請求", "把你根本不聽我說改成：我講完這件事後，你可以先用一句話說你聽到的重點嗎？"),
                ("觀察是否願意回來對話", "一次聽不懂可以練習；長期嘲笑、羞辱、控制或否認你的感受，請優先尋求可信任的人與專業安全支援。"),
            ],
            "faq": [
                ("為什麼我講很多次對方還是不聽？", "可能是壓力防衛、注意力分散、愛之語錯頻，也可能是對方不願承擔影響；羅盤會先幫你分辨模式。"),
                ("我該一直重複直到他懂嗎？", "不建議。先縮小成一句重點和一個可回答的請求，再觀察對方是否願意回來對話。"),
                ("如果對方總是否認我的感受呢？", "長期否認、嘲笑、羞辱或控制不是單純溝通技巧問題，請把自己的安全和支援放在前面。"),
            ],
        },
        "en": {
            "title": "Partner Doesn't Listen | LoveTypes",
            "desc": "If your partner does not listen, use the LoveTypes Compass to separate response gaps, love-language mismatch, pressure defense, and one answerable request.",
            "eyebrow": "LISTENING GAP",
            "h1": "Partner doesn't listen: turn not being heard into an answerable request",
            "intro": "If you searched partner doesn't listen, I keep saying it and nothing changes, or my partner interrupts and changes the subject, LoveTypes helps you separate whether they missed the point, defended under pressure, mismatched your love language, or repeatedly denied your feelings.",
            "primary": "Start free Relationship Compass",
            "secondary": "Open compatibility hub",
            "offer": "Request listening repair report",
            "offer_subject": "LoveTypes listening repair report request",
            "offer_body": "I want to request a LoveTypes listening repair report.\nMy guardian:\nTheir guardian:\nSituation where I feel unheard:\nMain point I want received:\nSmall request I can try first:\nReply email:\n",
            "sections": [
                ("Find the one point that was missed", "Do not replay the whole fight at once. Write the one sentence you most wanted them to hear and how they deflected, argued, or went silent."),
                ("Turn accusation into a response request", "Change you never listen to me into: after I say this, can you first tell me in one sentence what you heard?"),
                ("Watch whether they return to dialogue", "Misunderstanding once can be practiced. Repeated mockery, humiliation, control, or denial of your feelings means you should prioritize support and safety."),
            ],
            "faq": [
                ("Why does my partner still not listen after I say it many times?", "It may be pressure defense, distraction, love-language mismatch, or unwillingness to own impact. The compass names the pattern first."),
                ("Should I keep repeating until they get it?", "Usually no. Reduce it to one main point and one answerable request, then observe whether they return to dialogue."),
                ("What if they always deny my feelings?", "Long-term denial, mockery, humiliation, or control is not just a communication technique problem. Put your safety and support first."),
            ],
        },
        "ja": {
            "title": "相手が話を聞いてくれない時｜LoveTypes",
            "desc": "恋人が話を聞いてくれない、何度言っても伝わらない時、反応のずれ、愛の言語の錯頻、防衛反応と小さなお願いを整理します。",
            "eyebrow": "LISTENING GAP",
            "h1": "相手が話を聞いてくれない時は、聞かれなさを返しやすいお願いにする",
            "intro": "恋人が話を聞いてくれない、何度言っても伝わらない、話題をそらす時、LoveTypes は相手が要点を逃したのか、圧力で防衛しているのか、愛の言語がずれているのか、感情を否定し続けているのかを整理します。",
            "primary": "無料コンパスを始める",
            "secondary": "相性入口を見る",
            "offer": "傾聴修復レポートを希望",
            "offer_subject": "LoveTypes 傾聴修復レポート希望",
            "offer_body": "LoveTypes 傾聴修復レポートを希望します。\n私の守護者：\n相手の守護者：\n聞いてもらえないと感じる場面：\n本当に受け取ってほしい要点：\n最初に出せる小さなお願い：\n返信用 email：\n",
            "sections": [
                ("聞かれなかった要点を一つにする", "喧嘩全体をもう一度話す前に、一番聞いてほしかった一文と、相手がどうそらしたかを書きます。"),
                ("責め言葉を返答のお願いにする", "全然聞いてくれない、を、この話のあと、聞こえた要点を一文で返してくれる？に変えます。"),
                ("戻って対話する意思を見る", "一度のすれ違いは練習できます。嘲笑、侮辱、支配、感情の否定が続くなら安全支援を優先してください。"),
            ],
            "faq": [
                ("何度言っても聞いてくれないのはなぜ？", "圧力への防衛、注意の分散、愛の言語の錯頻、影響を引き受けない姿勢などが考えられます。"),
                ("伝わるまで繰り返すべきですか？", "通常はおすすめしません。一つの要点と返しやすいお願いに縮め、戻って話す意思があるか見ます。"),
                ("感情を否定され続ける場合は？", "長期の否定、嘲笑、侮辱、支配は単なる会話技術の問題ではありません。安全と支援を優先してください。"),
            ],
        },
        "ko": {
            "title": "상대가 내 말을 듣지 않을 때｜LoveTypes",
            "desc": "상대가 내 말을 듣지 않거나 여러 번 말해도 바뀌지 않을 때 반응 차이, 사랑 언어 엇갈림, 방어 반응과 작은 요청을 정리합니다.",
            "eyebrow": "LISTENING GAP",
            "h1": "상대가 내 말을 듣지 않는다면 들리지 않은 마음을 답할 수 있는 요청으로 바꾸세요",
            "intro": "상대가 내 말을 듣지 않는다, 여러 번 말해도 소용없다, 말을 끊거나 주제를 돌린다면 LoveTypes는 상대가 핵심을 놓친 건지, 압박 속에서 방어하는지, 사랑 언어가 엇갈리는지, 감정을 계속 부정하는지 정리합니다.",
            "primary": "무료 컴퍼스 시작",
            "secondary": "궁합 허브 보기",
            "offer": "듣기 회복 리포트 요청",
            "offer_subject": "LoveTypes 듣기 회복 리포트 요청",
            "offer_body": "LoveTypes 듣기 회복 리포트를 요청합니다.\n나의 수호자:\n상대 수호자:\n듣지 않는다고 느끼는 상황:\n진짜 받아들여졌으면 하는 핵심:\n먼저 말할 작은 요청:\n답장 email:\n",
            "sections": [
                ("놓친 핵심 한 문장 찾기", "싸움 전체를 반복하기보다 가장 듣고 싶었던 한 문장과 상대가 어떻게 피하거나 반박하거나 침묵했는지 씁니다."),
                ("비난을 반응 요청으로 바꾸기", "넌 내 말을 안 들어 대신 내가 말한 뒤 네가 들은 핵심을 한 문장으로 먼저 말해줄 수 있어?라고 요청합니다."),
                ("다시 대화할 의지가 있는지 보기", "한 번의 오해는 연습할 수 있습니다. 조롱, 모욕, 통제, 감정 부정이 반복된다면 안전과 지원을 우선하세요."),
            ],
            "faq": [
                ("여러 번 말해도 왜 듣지 않을까요?", "압박에 대한 방어, 주의 분산, 사랑 언어 엇갈림, 영향을 인정하지 않으려는 태도일 수 있습니다."),
                ("이해할 때까지 계속 반복해야 하나요?", "대개 권하지 않습니다. 한 가지 핵심과 답할 수 있는 요청으로 줄이고 다시 대화할 의지가 있는지 보세요."),
                ("감정을 계속 부정하면요?", "장기적 부정, 조롱, 모욕, 통제는 단순한 대화 기술 문제가 아닙니다. 안전과 지원을 먼저 두세요."),
            ],
        },
        "es": {
            "title": "Mi Pareja No Me Escucha | LoveTypes",
            "desc": "Si tu pareja no te escucha, separa brecha de respuesta, desajuste de lenguaje de amor, defensa bajo presión y una petición respondible.",
            "eyebrow": "LISTENING GAP",
            "h1": "Mi pareja no me escucha: convierte no ser escuchada en una petición respondible",
            "intro": "Si buscaste mi pareja no me escucha, lo digo muchas veces y nada cambia, o interrumpe y cambia el tema, LoveTypes ayuda a distinguir si no recibió el punto, se defendió bajo presión, hay desajuste de lenguaje de amor o niega tus sentimientos repetidamente.",
            "primary": "Empezar brújula gratis",
            "secondary": "Abrir hub de compatibilidad",
            "offer": "Pedir informe de escucha",
            "offer_subject": "Petición de informe LoveTypes escucha",
            "offer_body": "Quiero pedir un informe LoveTypes de escucha.\nMi guardiana:\nSu guardiana:\nSituación donde no me siento escuchada:\nPunto principal que quiero que reciba:\nPetición pequeña que puedo probar primero:\nEmail de respuesta:\n",
            "sections": [
                ("Encontrar el punto no escuchado", "No repitas toda la pelea de una vez. Escribe la frase que más querías que escuchara y cómo desvió, discutió o se quedó en silencio."),
                ("Convertir acusación en petición de respuesta", "Cambia nunca me escuchas por: después de decir esto, ¿puedes decirme en una frase qué entendiste?"),
                ("Observar si vuelve al diálogo", "Un malentendido puede practicarse. Burla, humillación, control o negación repetida de tus sentimientos requiere priorizar apoyo y seguridad."),
            ],
            "faq": [
                ("¿Por qué no escucha aunque lo diga muchas veces?", "Puede ser defensa bajo presión, distracción, desajuste de lenguaje de amor o no querer reconocer el impacto."),
                ("¿Debo repetir hasta que entienda?", "Normalmente no. Reduce a un punto principal y una petición respondible, luego observa si vuelve al diálogo."),
                ("¿Y si siempre niega mis sentimientos?", "La negación prolongada, burla, humillación o control no es solo un problema de técnica comunicativa. Prioriza seguridad y apoyo."),
            ],
        },
    },
    "taken-for-granted-relationship": {
        "zh": {
            "title": "被伴侶當成理所當然怎麼辦｜LoveTypes 關係羅盤",
            "desc": "當你覺得自己的付出被伴侶當成理所當然，LoveTypes 羅盤幫你分辨服務行動失衡、肯定需求、責任分工與可觀察的小改變。",
            "eyebrow": "UNSEEN EFFORT",
            "h1": "被伴侶當成理所當然：把委屈翻成被看見的請求",
            "intro": "如果你搜尋被伴侶當成理所當然、付出不被珍惜、taken for granted in relationship 或我做了很多卻沒被看見，LoveTypes 會先幫你分清楚：你需要一句肯定、需要實際分擔、需要被記得，還是這段關係已經長期責任失衡。",
            "primary": "開始免費關係羅盤",
            "secondary": "看心語合盤總入口",
            "offer": "登記被看見修復報告",
            "offer_subject": "LoveTypes 被看見修復報告需求",
            "offer_body": "我想登記 LoveTypes 被看見修復報告。\n我的守護者：\n對方守護者：\n我最常覺得被當成理所當然的情境：\n我希望被看見或分擔的部分：\n我可以先提出的小請求：\n可回覆 email：\n",
            "sections": [
                ("把付出列成可看見的事", "先寫下最近三件你主動承擔、照顧、安排或修復的事。越具體，越容易分辨是沒被看見，還是責任真的長期失衡。"),
                ("分清楚肯定和分工", "有時你需要的是一句被看見的肯定；有時需要的是對方真的接手一部分。兩種需求不要混成同一句抱怨。"),
                ("提出一個可觀察的小改變", "把你都不珍惜我改成：這週你能不能主動負責一次安排，並在我做完這件事後說一句你看見的地方？"),
            ],
            "faq": [
                ("被當成理所當然是不是代表對方不愛？", "不一定。可能是習慣、錯頻、壓力下忽略，也可能是責任失衡；羅盤會先幫你分辨模式。"),
                ("我是不是太需要被稱讚？", "想被看見不是太多。關鍵是把需要分成肯定、分工、時間或被記得，再提出具體請求。"),
                ("如果對方一直貶低我的付出呢？", "若對方長期嘲笑、貶低、羞辱、控制或要求你承擔全部責任，請優先尋求可信任的人與專業安全支援。"),
            ],
        },
        "en": {
            "title": "Taken for Granted in a Relationship | LoveTypes",
            "desc": "If you feel taken for granted in a relationship, use the LoveTypes Compass to separate unseen effort, affirmation needs, shared responsibility, and one observable change.",
            "eyebrow": "UNSEEN EFFORT",
            "h1": "Taken for granted in a relationship: turn resentment into a request to be seen",
            "intro": "If you searched taken for granted in a relationship, my effort is not appreciated, or I do so much and no one sees it, LoveTypes helps you separate whether you need affirmation, practical sharing, being remembered, or a boundary around long-term imbalance.",
            "primary": "Start free Relationship Compass",
            "secondary": "Open compatibility hub",
            "offer": "Request seen-effort repair report",
            "offer_subject": "LoveTypes seen-effort repair report request",
            "offer_body": "I want to request a LoveTypes seen-effort repair report.\nMy guardian:\nTheir guardian:\nSituation where I feel taken for granted:\nPart I want seen or shared:\nSmall request I can try first:\nReply email:\n",
            "sections": [
                ("Make your effort visible", "Write three recent things you initiated, cared for, planned, carried, or repaired. Specific moments make it easier to see whether effort is unnoticed or responsibility is truly uneven."),
                ("Separate affirmation from shared load", "Sometimes you need one sentence of recognition. Sometimes you need them to actually take over part of the work. Do not hide both needs inside one vague complaint."),
                ("Ask for one observable change", "Change you do not appreciate me into: this week, can you take charge of one plan and name one thing you noticed after I finish this?"),
            ],
            "faq": [
                ("Does being taken for granted mean they do not love me?", "Not always. It may be habit, mismatch, stress-related neglect, or responsibility imbalance; the compass names the pattern first."),
                ("Am I needing too much praise?", "Wanting to be seen is not too much. The key is to separate affirmation, shared responsibility, time, or being remembered into a concrete request."),
                ("What if they keep belittling my effort?", "If they repeatedly mock, belittle, humiliate, control, or expect you to carry all responsibility, prioritize trusted people and professional safety support."),
            ],
        },
        "ja": {
            "title": "恋人に当たり前だと思われる時｜LoveTypes",
            "desc": "自分の努力や気遣いが当たり前にされていると感じる時、肯定の必要、分担、責任の偏り、小さなお願いを整理します。",
            "eyebrow": "UNSEEN EFFORT",
            "h1": "当たり前にされる感覚は、見てほしいお願いに変える",
            "intro": "恋人に当たり前だと思われる、努力が大切にされない、たくさんしているのに見てもらえない時、LoveTypes は必要な肯定、実際の分担、覚えてほしいこと、長期的な偏りの境界を整理します。",
            "primary": "無料コンパスを始める",
            "secondary": "相性入口を見る",
            "offer": "見てもらう修復レポートを希望",
            "offer_subject": "LoveTypes 見てもらう修復レポート希望",
            "offer_body": "LoveTypes 見てもらう修復レポートを希望します。\n私の守護者：\n相手の守護者：\n当たり前にされていると感じる場面：\n見てほしい、または分担してほしい部分：\n最初に出せる小さなお願い：\n返信用 email：\n",
            "sections": [
                ("努力を見える事実にする", "最近あなたが始めた、整えた、気にかけた、背負った、修復したことを三つ書きます。具体化すると、見落としなのか偏りなのか分かりやすくなります。"),
                ("肯定と分担を分ける", "必要なのは一言の肯定かもしれませんし、実際に一部を引き受けてもらうことかもしれません。二つを一つの不満に混ぜないようにします。"),
                ("観察できる変化を一つ頼む", "大切にしてくれない、ではなく、今週一つ予定をあなたが決めて、私がしたことを一つ言葉にしてくれる？にします。"),
            ],
            "faq": [
                ("当たり前にされるのは愛がないからですか？", "必ずしもそうではありません。習慣、錯頻、ストレスによる見落とし、責任の偏りを分けます。"),
                ("褒めてほしいと思うのは求めすぎですか？", "見てもらいたいこと自体は求めすぎではありません。肯定、分担、時間、覚えてほしいことを具体的にします。"),
                ("努力を見下される場合は？", "嘲笑、見下し、侮辱、支配、全責任を背負わせる圧力が続くなら、安全支援を優先してください。"),
            ],
        },
        "ko": {
            "title": "당연하게 여겨지는 연애｜LoveTypes",
            "desc": "내 노력과 배려가 당연하게 여겨진다고 느낄 때 인정 욕구, 분담, 책임 불균형과 작은 요청을 정리합니다.",
            "eyebrow": "UNSEEN EFFORT",
            "h1": "당연하게 여겨지는 마음은 보이고 싶은 요청으로 바꿔야 합니다",
            "intro": "상대가 내 노력을 당연하게 여긴다, 내가 한 일이 소중하게 여겨지지 않는다, 많이 했는데 보이지 않는다고 느낀다면 LoveTypes는 필요한 인정, 실제 분담, 기억되고 싶은 마음, 장기적 불균형의 경계를 정리합니다.",
            "primary": "무료 컴퍼스 시작",
            "secondary": "궁합 허브 보기",
            "offer": "보임 회복 리포트 요청",
            "offer_subject": "LoveTypes 보임 회복 리포트 요청",
            "offer_body": "LoveTypes 보임 회복 리포트를 요청합니다.\n나의 수호자:\n상대 수호자:\n당연하게 여겨진다고 느끼는 상황:\n보이거나 나누고 싶은 부분:\n먼저 말할 작은 요청:\n답장 email:\n",
            "sections": [
                ("노력을 보이는 사건으로 쓰기", "최근 내가 먼저 시작하고, 챙기고, 계획하고, 떠안고, 회복한 일을 세 가지 적습니다. 구체적일수록 무시인지 불균형인지 보기 쉽습니다."),
                ("인정과 분담 나누기", "필요한 것이 인정 한마디일 수도 있고 실제로 일부를 맡아주는 것일 수도 있습니다. 두 욕구를 한 문장 불만에 섞지 않습니다."),
                ("관찰 가능한 변화 하나 요청하기", "넌 날 소중히 안 해 대신 이번 주 한 번은 네가 계획을 맡고, 내가 한 일 중 보였던 점 하나를 말해줄 수 있어?라고 요청합니다."),
            ],
            "faq": [
                ("당연하게 여겨지면 사랑하지 않는 건가요?", "반드시 그렇지는 않습니다. 습관, 엇갈림, 스트레스 속 무시, 책임 불균형을 먼저 나눠 봅니다."),
                ("제가 너무 인정받고 싶어 하나요?", "보이고 싶은 마음은 과한 것이 아닙니다. 인정, 분담, 시간, 기억됨 중 무엇인지 구체화하는 것이 중요합니다."),
                ("상대가 계속 내 노력을 깎아내리면요?", "조롱, 비하, 모욕, 통제, 모든 책임을 떠넘기는 압력이 반복된다면 안전과 지원을 우선하세요."),
            ],
        },
        "es": {
            "title": "Sentirse Dada por Sentada en la Relación | LoveTypes",
            "desc": "Si sientes que tu pareja te da por sentada, separa esfuerzo no visto, necesidad de afirmación, responsabilidad compartida y un cambio observable.",
            "eyebrow": "UNSEEN EFFORT",
            "h1": "Sentirse dada por sentada: convierte resentimiento en una petición de ser vista",
            "intro": "Si buscaste sentirme dada por sentada, mi esfuerzo no se valora o hago mucho y nadie lo ve, LoveTypes ayuda a distinguir si necesitas afirmación, reparto práctico, ser recordada o un límite ante un desequilibrio sostenido.",
            "primary": "Empezar brújula gratis",
            "secondary": "Abrir hub de compatibilidad",
            "offer": "Pedir informe de esfuerzo visto",
            "offer_subject": "Petición de informe LoveTypes esfuerzo visto",
            "offer_body": "Quiero pedir un informe LoveTypes de esfuerzo visto.\nMi guardiana:\nSu guardiana:\nSituación donde me siento dada por sentada:\nParte que quiero que vea o comparta:\nPetición pequeña que puedo probar primero:\nEmail de respuesta:\n",
            "sections": [
                ("Hacer visible tu esfuerzo", "Escribe tres cosas recientes que iniciaste, cuidaste, planeaste, cargaste o reparaste. Lo concreto ayuda a ver si no se nota o si la responsabilidad es desigual."),
                ("Separar afirmación de reparto", "A veces necesitas una frase de reconocimiento. Otras veces necesitas que tome parte real del trabajo. No escondas ambas necesidades en una queja vaga."),
                ("Pedir un cambio observable", "Cambia no me valoras por: esta semana, ¿puedes encargarte de un plan y nombrar una cosa que viste cuando terminé esto?"),
            ],
            "faq": [
                ("¿Que me dé por sentada significa que no me ama?", "No siempre. Puede ser hábito, desajuste, descuido por estrés o desequilibrio de responsabilidad; la brújula nombra el patrón primero."),
                ("¿Necesito demasiada aprobación?", "Querer ser vista no es demasiado. La clave es separar afirmación, responsabilidad compartida, tiempo o ser recordada en una petición concreta."),
                ("¿Y si menosprecia mi esfuerzo?", "Si se burla, menosprecia, humilla, controla o espera que cargues toda la responsabilidad, prioriza personas de confianza y apoyo profesional de seguridad."),
            ],
        },
    },
    "partner-needs-space-relationship": {
        "zh": {
            "title": "伴侶說需要空間怎麼辦｜LoveTypes 關係羅盤",
            "desc": "當伴侶說需要空間、想冷靜或暫時少聯絡，LoveTypes 幫你分辨冷卻需求、逃避模式、聯絡節奏與可說出口的安全請求。",
            "eyebrow": "SPACE REQUEST",
            "h1": "伴侶說需要空間：先把恐慌縮成一個清楚的聯絡約定",
            "intro": "如果你搜尋伴侶說需要空間、他想冷靜是不是不愛了、partner needs space 或突然少聯絡怎麼辦，LoveTypes 會先幫你分清楚：這是暫時冷卻、壓力下退開、逃避溝通，還是關係裡需要被保護的界線。",
            "primary": "開始免費關係羅盤",
            "secondary": "看心語合盤總入口",
            "offer": "登記空間修復報告",
            "offer_subject": "LoveTypes 空間修復報告需求",
            "offer_body": "我想登記 LoveTypes 空間修復報告。\n我的守護者：\n對方守護者：\n對方說需要空間的情境：\n我最害怕失去的部分：\n我們可以約定的聯絡節奏：\n可回覆 email：\n",
            "sections": [
                ("先問清楚空間的範圍", "空間不是消失。你可以把問題縮成：你需要幾天？這段時間是否仍回報安全？什麼時候再談？"),
                ("分辨冷卻和逃避", "健康的冷卻會留下回來談的時間；逃避則長期不說、不約定、不回應你的基本安全感。"),
                ("把追問改成聯絡約定", "把你是不是不愛我了改成：我可以給你兩天安靜，但我們能不能約週五晚上 20 分鐘把下一步說清楚？"),
            ],
            "faq": [
                ("伴侶需要空間是不是代表要分手？", "不一定。有人需要冷卻才能好好說話，也有人用空間逃避責任；關鍵是是否願意約定回來談的時間。"),
                ("我可以一直傳訊息確認嗎？", "通常不建議。把確認需求縮成一個明確約定，比連續追問更容易保護彼此的安全感。"),
                ("如果對方用空間懲罰我呢？", "若對方用失聯、威脅、羞辱或冷暴力讓你屈服，這不只是溝通問題，請優先找可信任的人與專業支援。"),
            ],
        },
        "en": {
            "title": "When Your Partner Needs Space | LoveTypes",
            "desc": "If your partner says they need space, use the LoveTypes Compass to separate cooling down, avoidance, contact rhythm, boundaries, and one safe request.",
            "eyebrow": "SPACE REQUEST",
            "h1": "When your partner needs space, turn panic into one clear contact agreement",
            "intro": "If you searched my partner needs space, does needing space mean breakup, or they suddenly text less, LoveTypes helps you separate temporary cooling down, pulling back under stress, avoiding the conversation, and a boundary that still needs safety.",
            "primary": "Start free Relationship Compass",
            "secondary": "Open compatibility hub",
            "offer": "Request space repair report",
            "offer_subject": "LoveTypes space repair report request",
            "offer_body": "I want to request a LoveTypes space repair report.\nMy guardian:\nTheir guardian:\nSituation where they asked for space:\nWhat I am most afraid to lose:\nContact rhythm we could agree on:\nReply email:\n",
            "sections": [
                ("Clarify the shape of space", "Space is not the same as disappearing. Ask: how many days do you need, will we still confirm safety, and when do we talk again?"),
                ("Separate cooling down from avoidance", "Healthy cooling down leaves a time to return. Avoidance keeps refusing clarity, timing, and your basic need for safety."),
                ("Turn pursuit into an agreement", "Change do you not love me anymore into: I can give you two quiet days, and can we set Friday for a 20-minute next-step talk?"),
            ],
            "faq": [
                ("Does needing space mean breakup?", "Not always. Some people need cooling down to speak well; others use space to avoid responsibility. The key is whether they will agree to return to the conversation."),
                ("Should I keep texting for reassurance?", "Usually no. Shrink the reassurance need into one clear agreement instead of repeated pursuit."),
                ("What if they use space to punish me?", "If they use disappearance, threats, humiliation, or silent treatment to make you submit, prioritize trusted people and professional support."),
            ],
        },
        "ja": {
            "title": "恋人に距離を置きたいと言われた時｜LoveTypes",
            "desc": "恋人が距離や時間を求めた時、冷却、回避、連絡のリズム、境界、安全なお願いを整理します。",
            "eyebrow": "SPACE REQUEST",
            "h1": "距離を置きたいと言われたら、不安を連絡の約束に変える",
            "intro": "恋人に距離を置きたいと言われた、冷静になりたいと言われた、急に連絡が減った時、LoveTypes は一時的な冷却、ストレスで退く反応、会話回避、守るべき境界を分けます。",
            "primary": "無料コンパスを始める",
            "secondary": "相性入口を見る",
            "offer": "距離の修復レポートを希望",
            "offer_subject": "LoveTypes 距離の修復レポート希望",
            "offer_body": "LoveTypes 距離の修復レポートを希望します。\n私の守護者：\n相手の守護者：\n距離が必要と言われた場面：\n一番失うのが怖いこと：\n約束できそうな連絡リズム：\n返信用 email：\n",
            "sections": [
                ("距離の形を確認する", "距離は消えることではありません。何日必要か、安全確認はするか、いつ再び話すかを聞きます。"),
                ("冷却と回避を分ける", "健康な冷却には戻って話す時間があります。回避は明確さ、時期、基本的な安心を長く拒みます。"),
                ("追いかける代わりに約束する", "もう好きじゃないの？ではなく、二日静かにするから金曜に20分だけ次を話せる？にします。"),
            ],
            "faq": [
                ("距離を置きたいは別れたいという意味ですか？", "必ずしもそうではありません。冷却が必要な人もいれば責任を避ける人もいます。戻って話す約束があるかが大切です。"),
                ("安心したくて何度も連絡していいですか？", "多くの場合おすすめしません。何度も追うより、一つの明確な約束に縮めます。"),
                ("距離を罰として使われる場合は？", "失踪、脅し、侮辱、無視で従わせようとするなら、安全と信頼できる支援を優先してください。"),
            ],
        },
        "ko": {
            "title": "상대가 시간이 필요하다고 할 때｜LoveTypes",
            "desc": "상대가 공간이나 시간이 필요하다고 할 때 식히기, 회피, 연락 리듬, 경계와 안전한 요청을 정리합니다.",
            "eyebrow": "SPACE REQUEST",
            "h1": "상대가 시간이 필요하다고 하면 불안을 하나의 연락 약속으로 줄이세요",
            "intro": "상대가 시간이 필요하다고 한다, 잠시 식히자고 한다, 갑자기 연락이 줄었다면 LoveTypes는 일시적 진정, 스트레스 속 후퇴, 대화 회피, 지켜야 할 경계를 나눠 봅니다.",
            "primary": "무료 컴퍼스 시작",
            "secondary": "궁합 허브 보기",
            "offer": "공간 회복 리포트 요청",
            "offer_subject": "LoveTypes 공간 회복 리포트 요청",
            "offer_body": "LoveTypes 공간 회복 리포트를 요청합니다.\n나의 수호자:\n상대 수호자:\n상대가 시간이 필요하다고 한 상황:\n내가 가장 잃을까 두려운 부분:\n약속할 수 있는 연락 리듬:\n답장 email:\n",
            "sections": [
                ("공간의 범위 확인하기", "공간은 사라지는 것이 아닙니다. 며칠이 필요한지, 안전 확인은 할지, 언제 다시 이야기할지 묻습니다."),
                ("진정과 회피 구분하기", "건강한 진정은 다시 돌아와 이야기할 시간을 남깁니다. 회피는 명확함, 시점, 기본 안정감을 오래 거부합니다."),
                ("추궁을 약속으로 바꾸기", "나를 사랑하지 않는 거야? 대신 이틀은 조용히 줄게. 금요일에 20분만 다음 단계를 이야기할 수 있어?라고 말합니다."),
            ],
            "faq": [
                ("시간이 필요하다는 말은 이별 뜻인가요?", "반드시 그렇지는 않습니다. 진정이 필요한 사람도 있고 책임을 피하는 사람도 있습니다. 다시 대화할 약속이 있는지가 중요합니다."),
                ("불안해서 계속 연락해도 되나요?", "대개 권하지 않습니다. 반복 추궁보다 하나의 분명한 연락 약속으로 줄이는 편이 낫습니다."),
                ("공간을 벌로 쓰면요?", "잠수, 위협, 모욕, 무시로 복종하게 만든다면 단순 소통 문제가 아닙니다. 안전과 신뢰할 수 있는 지원을 우선하세요."),
            ],
        },
        "es": {
            "title": "Cuando Tu Pareja Pide Espacio | LoveTypes",
            "desc": "Si tu pareja dice que necesita espacio, separa enfriamiento, evitación, ritmo de contacto, límites y una petición segura.",
            "eyebrow": "SPACE REQUEST",
            "h1": "Cuando tu pareja pide espacio, convierte el pánico en un acuerdo claro de contacto",
            "intro": "Si buscaste mi pareja necesita espacio, pedir espacio significa ruptura o de pronto escribe menos, LoveTypes ayuda a distinguir enfriamiento temporal, retiro por estrés, evitación de la conversación y un límite que aún necesita seguridad.",
            "primary": "Empezar brújula gratis",
            "secondary": "Abrir hub de compatibilidad",
            "offer": "Pedir informe de espacio y reparación",
            "offer_subject": "Petición de informe LoveTypes espacio y reparación",
            "offer_body": "Quiero pedir un informe LoveTypes de espacio y reparación.\nMi guardiana:\nSu guardiana:\nSituación donde pidió espacio:\nLo que más temo perder:\nRitmo de contacto que podríamos acordar:\nEmail de respuesta:\n",
            "sections": [
                ("Aclarar la forma del espacio", "Espacio no es desaparecer. Pregunta cuántos días necesita, si confirmarán seguridad y cuándo volverán a hablar."),
                ("Separar enfriar de evitar", "Un enfriamiento sano deja una hora para volver. La evitación rechaza claridad, momento y tu necesidad básica de seguridad."),
                ("Cambiar persecución por acuerdo", "Cambia ya no me amas por: puedo darte dos días tranquilos, ¿y el viernes hablamos 20 minutos del siguiente paso?"),
            ],
            "faq": [
                ("¿Pedir espacio significa ruptura?", "No siempre. Algunas personas necesitan enfriarse para hablar bien; otras usan espacio para evitar responsabilidad. Importa si acepta volver a la conversación."),
                ("¿Debo escribir muchas veces para calmarme?", "Normalmente no. Reduce la necesidad de seguridad a un acuerdo claro en vez de perseguir repetidamente."),
                ("¿Y si usa el espacio para castigarme?", "Si usa desaparición, amenazas, humillación o silencio para someterte, prioriza personas de confianza y apoyo profesional."),
            ],
        },
    },
}
...
COMPASS_SEARCH_TASKS = {
    "zh": {
        ...
        "tool_cta": "直接開始免費羅盤",
        "items": [
            ("想理解我們為何錯頻", "比較兩個愛之語入口，但不評分相配程度，也不做命運判決。", "compass", "love_compatibility"),
...
def collector_card(lang: str, slug: str, compact: bool = False) -> str:
    ...
    contact_href = "/contact/#site-repair-report" if lang == "zh" else supply_request_href(lang, slug)
    contact_label = "回報內容問題" if lang == "zh" else SUPPLY_LABELS[lang]["request_supply"]
    data_attrs = (
...
<article class="{class_name}" id="keepsake-card-{slug}">
  ...
  <div>
    ...
    <div class="collector-actions">
      ...
      <a class="secondary-btn" href="{contact_href}" data-funnel-event="collector_content_report">{escape(contact_label)}</a>
...
def quiz_payload(lang: str) -> str:
    ...
    for key, meta in QUIZ_TYPES.items():
        ...
        if lang == "zh":
            ...
            starter_kit = {
                "eyebrow": "免費練習起點",
                "title": "把結果變成一個可完成的下一步",
                "intro": "不需要一次完成所有內容。先理解結果，再選一個小練習，最後把需要說成可協商的請求。",
                "steps": [
                    {"number": "1", "title": "讀懂結果", "desc": route["desc"], "action": "閱讀對應指南", "href": guide_url},
                    {"number": "2", "title": "做一個小練習", "desc": route["mission"], "action": "填寫 7 日修復表", "href": plan_url},
                    {"number": "3", "title": "整理一句請求", "desc": "用羅盤拆開觀察、感受、需要與請求。", "action": "打開關係羅盤", "href": compass_url},
                    {"number": "4", "title": "理解守護者", "desc": domain_desc, "action": "閱讀守護者頁", "href": guardian_url},
                ],
            }
        else:
            starter_kit = starter_kit_payload(lang, resource_url)
        results[key] = {
            "name": name,
            "type": typ,
            "desc": desc,
    ...
    if lang == "zh":
        labels.update({
            ...
            "book_step": "延伸理解",
            "book_intro": "對應指南",
            "saved_intro": "你的上次結果只保存在這台裝置的瀏覽器。可以直接回到修復計畫、關係羅盤或守護者頁。",
            "guide_resume_intro": "讀完這篇後，可以回到修復計畫、守護者頁或關係羅盤，把理解接成下一步。",
            "guardian_resume_intro": "這台裝置保留了上次測驗結果。從這裡回到守護者頁、修復計畫或關係羅盤。",
            "guardian_resume_match": "這是你上次認領的守護者。先理解容易受傷的情境，再選一個可完成的小練習。",
            "saved_route": "閱讀相關指南",
            "saved_luna": "繼續 7 日修復",
            "saved_card": "查看守護者頁",
    ...
    payload = {
        ...
        "supplySafety": (
            {
                "chooseTitle": "如何選擇下一步",
                "chooseText": "先選一個最貼近當下狀態的免費練習，不必一次讀完所有內容。如果關係正處於危險、控制、暴力或高壓狀態，請優先尋求可信任的人與專業支持。",
                "notNowTitle": "什麼時候應先停下來",
                "notNowText": "如果你想用練習替代道歉、逼對方改變，或在情緒很滿時要求立即回答，請先暫停。LoveTypes 只支持覺察與溝通，不判斷關係去留。",
            }
            if lang == "zh"
            else {
...
(() => {{
      ...
      <article class="${{articleClass}}" style="--result-accent:${{result.domainAccent || result.color}};--domain-glow:${{result.domainGlow || result.color}}">
        ...
        <div>
          ...
          <div class="${{actionsClass}}">
            <a href="${{result.guideUrl}}" data-home-resume-guide>${{quiz.labels.saved_route}}</a>
            <a href="${{result.planUrl}}" data-home-saved-plan data-home-resume-plan>${{quiz.labels.saved_plan}}</a>
            <a href="${{result.compassUrl}}" data-home-resume-compass>${{quiz.labels.conversion_compass_action}}</a>
  ...
  async function renderResult() {{
    ...
    resultBox.innerHTML = `
      ...
      <section class="callout safety quiz-result-boundary" data-quiz-result-boundary>
...
def write_llms_txt() -> None:
    ...
    for slug, data in GUARDIANS.items():
        ...
        guardian_lines.append(f"- {zh_name}（{zh_language}）：{zh_desc} {DOMAIN}/characters/{slug}/")
...
- 7 日修復計畫：{DOMAIN}/repair-plan/
- 原創實測紀錄：{DOMAIN}/lab/
- 理論與研究限制：{DOMAIN}/theory/
- 關於與編輯方法：{DOMAIN}/about/
- 隱私政策：{DOMAIN}/privacy/
- 使用條款：{DOMAIN}/terms/
...
Repair Plan: {DOMAIN}/repair-plan/
Product Lab: {DOMAIN}/lab/
...
def write_site_manifest() -> None:
    ...
    manifest = {
        ...
        "description": "五種愛之語測驗、情感守護者、關係指南與免費修復練習。",
        "start_url": "/",
        "scope": "/",
        "display": "standalone",
        ...
        "shortcuts": [
            ...
            {"name": "7 日修復計畫", "url": "/repair-plan/", "description": "把測驗結果轉成七天內可以完成的小練習。", "icons": shortcut_icon},
            {"name": "產品實測紀錄", "url": "/lab/", "description": "查看測驗、隱私、可及性與失敗情境的實測證據。", "icons": shortcut_icon},
        ],
    }
...
def collect_funnel_events() -> dict:
    ...
    html_paths = [
        ROOT / path / "index.html" if path else ROOT / "index.html"
    ...
    add_event("campaign_landing", "/start/")
