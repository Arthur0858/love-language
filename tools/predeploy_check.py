...
PYTHON_TOOLS = [
    ...
    "tools/promotion_lead_mailto_importability_audit.py",
...
def main() -> int:
    ...
    if not args.visual_only:
        ...
        if args.site_only:
            ...
            run_step(
                "public availability stability smoke tests",
                [sys.executable, "-m", "unittest", "tools.tests.test_public_availability_stability_smoke"],
            )
