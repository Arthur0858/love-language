...
REFRESH_COMMANDS = [
    ...
    [sys.executable, "tools/promotion_proof_note_policy.py"],
    ...
    [sys.executable, "tools/promotion_render_bridge.py"],
    ...
    [sys.executable, "tools/promotion_profile_proof_capture_quickstart.py"],
    [sys.executable, "tools/promotion_profile_batch_import.py"],
    [sys.executable, "tools/promotion_profile_setup_handoff_pack.py"],
    ...
    [sys.executable, "tools/promotion_kpi_zero_source_rehearsal.py"],
    ...
    [sys.executable, "tools/promotion_post_proof_handoff_pack.py"],
    ...
    [sys.executable, "tools/promotion_launch_blocker_digest.py"],
    ...
    [sys.executable, "tools/promotion_lead_intake_closure_quickstart.py"],
