...
def build_gate() -> dict:
    ...
    evidence_complete = evidence_issues == 0 and evidence_required == evidence_traceable
    ...
    if not evidence_complete:
        blockers.append({
            ...
            "message": f"traceable evidence {evidence_traceable}/{evidence_required}, evidence issues {evidence_issues}.",
