...
def build_rows() -> list[dict[str, object]]:
    ...
    rows: list[dict[str, object]] = [
        ...
        },
        {
            ...
            "owner_action": "Confirm all active first-batch rows are ready before opening platform publishing.",
            "evidence_required": "first-batch publish action sheet has all active rows ready and zero issues.",
        ...
        },
        {
            ...
            "required_value": max(published_rows, publish_rows),
            "owner_action": "Confirm every first-batch post has traceable public URL evidence.",
            "evidence_required": "first-batch completion gate traceablePostEvidence matches all active published rows.",
