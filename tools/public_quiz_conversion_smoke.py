...
RESUME_TEMPLATE_CASES = (
    (
        ...
        "garden-map",
        {
            ...
            "supply action": "data-garden-map-route",
            "plan action": "data-garden-map-plan",
            "keepsake action": "data-garden-map-keepsake",
            "luna action": "data-garden-map-luna",
            "contact action": "data-garden-map-contact",
    ...
    (
        ...
        "characters",
        {
            ...
            "contact action": "data-guardian-resume-contact",
    ...
    (
        ...
        "guides/share-your-result",
        {
            ...
            "plan action": "data-guide-resume-plan",
            "guardian action": "data-guide-resume-guardian",
            "supply action": "data-guide-resume-route",
            "luna action": "data-guide-resume-luna",
            "keepsake action": "data-guide-resume-keepsake",
            "contact action": "data-guide-resume-contact",
    ...
    (
        ...
        "resources",
        {
            ...
            "plan action": "data-supply-resume-plan",
            "luna action": "data-supply-resume-luna",
            "keepsake action": "data-supply-resume-keepsake",
            "contact action": "data-supply-resume-contact",
    ...
    (
        ...
        "keepsakes",
        {
            ...
            "supply action": "data-keepsake-route",
            "guardian action": "data-keepsake-guardian",
            "keepsake action": "data-keepsake-keepsake",
    ...
    (
        ...
        "repair-plan",
        {
            ...
            "supply action": "data-repair-resume-route",
            "plan action": "data-repair-resume-plan",
            "keepsake action": "data-repair-resume-keepsake",
            "luna action": "data-repair-resume-luna",
            "contact action": "data-repair-resume-contact",
            "book action": "result.supplyBookUrl",
    ...
    (
        ...
        "luna-yoga-music",
        {
            ...
            "pass stamp": "data-resume-pass-stamp",
            "plan action": "data-luna-resume-plan",
            "supply action": "data-luna-resume-route",
            "luna action": "data-luna-resume-luna",
            "keepsake action": "data-luna-resume-keepsake",
            "contact action": "data-luna-resume-contact",
            "book action": "result.supplyBookUrl",
            "affiliate rel": 'rel="noopener noreferrer sponsored"',
