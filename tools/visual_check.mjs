...
const cases = [
  ...
  { name: 'compass-desktop', path: '/compass/', viewport: { width: 1280, height: 900 } },
  { name: 'compass-mobile', path: '/compass/', viewport: { width: 390, height: 844 } },
  { name: 'compatibility-desktop', path: '/tools/love-compatibility/', viewport: { width: 1280, height: 900 } },
  { name: 'compatibility-mobile', path: '/tools/love-compatibility/', viewport: { width: 390, height: 844 } },
